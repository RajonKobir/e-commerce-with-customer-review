                            ...
                            <table class="table app-table-hover mb-0 text-left">
                                ...
                                <tbody>
                                    @foreach ($brands as $brand)
                                        <tr>
                                            <td class="cell">{{ $brand->id }}</td>
                                            <td class="cell"><span class="truncate">{{ $brand->title }}</span></td>
                                            <td class="cell">
                                                <img src="/img/{{ $brand->image }}" alt="Image of {{ $brand->title }}" class="img-fluid img-thumbnail" style="width: 100px">
                                            </td>
                                            <td class="cell">
